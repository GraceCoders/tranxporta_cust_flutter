...
import 'package:tranxporta/common_widget/button_widget_white.dart';
...
class DeliveriesDetailsScreen extends StatefulWidget {
  const DeliveriesDetailsScreen({Key? key}) : super(key: key);

  @override
  _DeliveriesDetailsScreenState   createState() => _DeliveriesDetailsScreenState();
}
            ...
            child: Form(
              ...
              child: Column(
                ...
                children: [
                        ...
                        Expanded(
                          child: Row(
                            ...
                            children: [
                              ...
                              Padding(
                                padding: const EdgeInsets.only(top: 10,right: 15,bottom: 20),
                                child:  Text(
                                  "110",
                                  style: TextStyleConstants.commonStyleFour,
                                  textAlign: TextAlign.center,
                  ...
                  //     mainAxisAlignment: MainAxisAlignment.start,
                  //     children: [
                  //       ButtonWidgetWhite(buttonName: 'Track',onpressed: valfn),
                  //
                  //     ],
                  //   ),
                  // ),
